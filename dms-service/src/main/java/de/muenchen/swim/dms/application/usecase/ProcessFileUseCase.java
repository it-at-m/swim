package de.muenchen.swim.dms.application.usecase;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import de.muenchen.swim.dms.application.port.in.ProcessFileInPort;
import de.muenchen.swim.dms.application.port.out.DmsOutPort;
import de.muenchen.swim.dms.application.port.out.FileEventOutPort;
import de.muenchen.swim.dms.application.port.out.FileSystemOutPort;
import de.muenchen.swim.dms.configuration.SwimDmsProperties;
import de.muenchen.swim.dms.domain.exception.MetadataException;
import de.muenchen.swim.dms.domain.exception.PresignedUrlException;
import de.muenchen.swim.dms.domain.exception.UnknownUseCaseException;
