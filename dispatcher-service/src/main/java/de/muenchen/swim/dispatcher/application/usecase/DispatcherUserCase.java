...
import de.muenchen.swim.dispatcher.application.port.out.FileDispatchingOutPort;
...
import de.muenchen.swim.dispatcher.application.port.out.StoreProtocolOutPort;
import de.muenchen.swim.dispatcher.configuration.SwimDispatcherProperties;
import de.muenchen.swim.dispatcher.domain.exception.FileSizeException;
import de.muenchen.swim.dispatcher.domain.exception.MetadataException;
