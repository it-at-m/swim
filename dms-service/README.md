...
swim:
  ...
  # shadow file cleanup (see section "Leader Election")
  shadow-file-cleanup:
    cron: "0 0 3 ? * MON#1" # Cron for triggering the cleanup (default: first monday a month 3:00)
...
There are operations which only should be executed on one instance of the dms-service (e.g. shadow file cleanup).
